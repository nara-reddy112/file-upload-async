...
class BulkCreateManager(object):
    """
    Keep track of ORM objects to be created for multiple model classes,
    Automatically create those objects with `bulk_create`,
    when the number of objects accumulated for a given model class exceeds
    `chunk_size`.
    Upon completion of the loop that's `add()`ing objects,
